...
import FATFromMKTMobile from "./FATFromMKTMobile";
...
const FATFromMKT = () => {
  ...
  const executeSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${backEndUrl}/receipt/process/fat/from/mkt`,
        payload,
        { withCredentials: true },
      );
  ...
  const mainColumns = [
    ...
    { title: "SPP No", dataIndex: "sppno", key: "sppno" },
    {
      ...
      dataIndex: "created",
      key: "created",
      render: (text) => DateTime.fromISO(text).toFormat("dd-MM-yyyy HH:mm:ss"),
    },
    {
