...
const DPKFromDelivery = () => {
    ...
    const executeSubmit = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${backEndUrl}/receipt/process/dpk/from/delivery`, payload, { withCredentials: true });
...
export default DPKFromDelivery;